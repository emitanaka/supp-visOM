...
(ref:lineup-demo) Due to lack of space, only 

```{r lineup-demo, fig.height = 10, fig.width = 10, fig.cap = "(ref:lineup-demo)"}
plot_lineup_theirs %+% filter(lineup_data, .sample %in% 1:4) +
